...
var resolvers = {
    ...
    Query: __assign(__assign({ users: function (_, args, context) {
        ...
        } }, article_controller_2.ArticleQueries), comment_controller_1.CommentQueries),
    Mutation: __assign(__assign({ createAccount: function (_, _a, context) {
        ...
        } }, article_controller_1["default"]), comment_controller_1.CommentMutations)
};
